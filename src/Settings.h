...
*/
    ...
    //////////Testing\\\\\\\\\\
    //General
    #define BACKGROUND_COLOR CLITERAL(Color){40, 40, 40, 255}
    #define TITLE_COLOR CLITERAL(Color){144, 238, 144, 255}

    //View
    #define VIEW_BACKGROUND_BLUR CLITERAL(Color){200, 200, 200, 185}

    //Button
    #define BUTTON_COLOR CLITERAL(Color){0, 191, 255, 255}
    #define BUTTON_HOVER_COLOR CLITERAL(Color){30, 144, 255, 255}
